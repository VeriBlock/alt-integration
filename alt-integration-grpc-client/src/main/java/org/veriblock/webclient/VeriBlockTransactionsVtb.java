...
public class VeriBlockTransactionsVtb {
    ...
    public static VeriBlockPoPTransaction createVtbAttachedToBitcoinBlock(Sha256Hash previousBlockHash) throws SignatureException {
        String sender = VeriBlockSignatureKeys.getDefaultAddress();
        byte[] publicKey = VeriBlockSignatureKeys.getDefaultPublicKey();

        VeriBlockBlock publishedBlock = SerializeDeserializeService.parseVeriBlockBlock(Base64.getDecoder().decode("AAATNQACp5PIctb2Rg6QvtYjQruWgZX4xRXT7tcnegnvrEvpn5XwoVYosGujtEwBkLXASVybis0HAcUjXru+nA=="));
    ...
    public static VeriBlockPoPTransaction createVtb() throws SignatureException {
    ...
    public static VeriBlockPublication createVtbPublicationAttached(VeriBlockBlock attachToBlock, VeriBlockPoPTransaction tx) throws SignatureException {
        ...
        VeriBlockMerklePath proof = tree.getMerklePath(SerializeDeserializeService.getId(tx), 0, false);
    ...
    public static VeriBlockPublication createVtbPublicationNotAttached() throws SignatureException {
