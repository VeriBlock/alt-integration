...
public class SetVeriBlockProofChange extends Change {
    @Override
    ...
    public Operation getOperation() {
        return Operation.SET_PROOF;
    }

    public SetVeriBlockProofChange(StoredVeriBlockBlock oldValue, StoredVeriBlockBlock newValue) {
